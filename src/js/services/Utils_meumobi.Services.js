(function() {
	...
	angular
	.module('meumobi-angular-toolkit.utils', ['meumobi-angular-toolkit.cordova'])
	.factory('UtilsService', ['deviceReady', 'striptagsFilter', 'br2nlFilter', 'translateFilter', UtilsService]);

	function UtilsService(deviceReady, striptags, br2nl, translate, $log) {
		var service = {};
		...
		function nativeFlipTransition(options) {
			$log.debug(path);
			/*
			var options = {
